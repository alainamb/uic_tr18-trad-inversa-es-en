...
3. Si no eres la primera persona en hacer tu espacio de trabajo, haz clic en el ícono + junto a las pestañas con los nombres de las otras personas para el tuyo
4. Verifica que puedes ver el texto completo del documento
...
> "Error de terminología: 'roundtable' no es el término apropiado en este contexto diplomático. Debería ser 'working group' o 'working table' para reflejar mejor el concepto de 'mesa de trabajo' en comunicados oficiales."
...
Después de identificar errores individuales, proporciona puntuaciones de:
...
- Más **comentarios holísticos**: Observaciones sobre patrones de errores, fortalezas generales, y efectividad del documento
...
**CRÍTICO:** Una vez completada la evaluación en Label Studio, comunícate inmediatamente con las personas revisoras para:
...
Descarga el archivo de la traducción automática en [formato de MS Word](https://github.com/alainamb/uic_tr18-trad-inversa-es-en/blob/main/unidad4/semana12/referencias/T-MEC-TraducciónAutomática.zip).

#### Paso 2: Activar control de cambios

1. Abre el archivo en MS Word
2. Activa **Control de cambios** (*Track Changes*; Revisar > Control de cambios)
3. Asegúrate de que todos los cambios queden visibles
4. **Para grupos de 3:** Cada persona debe usar su propio archivo para hacer las correcciones
...
Comparen sus resultados y redacten una reflexión grupal que incluya:
...
|----------|-------------|---------------------|
| Evaluación MQM en Label Studio (Estudiante A) | | |
| Implementación de correcciones en Word (Estudiante B) | | |
| Implementación de correcciones en Word (Estudiante C) | | |
| Comunicación | | |
...
1. **Calidad de los comentarios de evaluación:** Al implementar las correcciones en Word, ¿fueron los comentarios de Label Studio lo suficientemente claros y específicos? ¿Hubo casos donde los comentarios no dieron suficiente información para hacer la corrección correcta? Si otra persona fuera a implementar las correcciones basándose solo en los comentarios, ¿podría hacerlo exitosamente?

2. **Desafíos del doble rol:** ¿Qué diferencias notaste entre pensar como la persona evaluadora (identificando y explicando errores) versus pensar como la persona revisora (implementando las correcciones)? ¿Cuál rol les parece más difícil y por qué?

3. **Aprendizaje sobre UVT y PVT:** Después de trabajar en ambas fases de este proyecto, ¿cómo ha evolucionado su comprensión de la diferencia entre traducción no verificada (UVT) y traducción verificada profesionalmente (PVT)? ¿Qué habilidades específicas se requieren para convertir UVT en PVT?
...
|----------------|--------------|----------------|
| **Evaluación MQM en Label Studio** (1 punto) | **Excelente:** Identificación precisa de errores con comentarios claros, específicos y accionables que permiten a otra persona implementar las correcciones sin ambigüedad<br>**Insuficiente:** Errores identificados pero comentarios poco claros que no permitieron a las personas revisoras implementar las correcciones apropiadamente | 1 punto<br>0 puntos |
| **Implementación de correcciones en Word** (1 punto) | **Excelente:** Todas las correcciones implementadas consistentemente con los comentarios de evaluación; control de cambios usado apropiadamente; en grupos de 3, coordinación efectiva visible<br>**Insuficiente:** Correcciones incompletas o inconsistentes con los comentarios de evaluación; pobre coordinación en grupos de 3 | 1 punto<br>0 puntos |
| **Reflexión crítica colaborativa** (1 punto) | **Excelente:** Reflexión profunda de todas las personas sobre comunicación, calidad de comentarios, y proceso colaborativo; registros de tiempo completos; demuestra metacognición sobre evaluación, revisión y trabajo en equipo; análisis genuino de la dinámica grupal<br>**Insuficiente:** Reflexión muy breve o incompleta; falta participación de algún integrante; no demuestra pensamiento crítico sobre el proceso colaborativo | 1 punto<br>0 puntos |
...
- **Las personas evaluadoras** identifican problemas y comunican qué necesita corregirse
- **Las personas revisoras** implementan las correcciones basándose en esa comunicación
...
- **Guía de Label Studio**: [Semana 9 - Introducción a Label Studio](../../unidad3/semana9/intro-a-label-studio.md)
- **Tipología MQM**: [themqm.org/the-mqm-typology](https://themqm.org/the-mqm-typology/)
...
**¡Unidad 4 Completa!** Repasen lo que han logrado en la [Conclusión de la Unidad 4](../unidad4-conclusion.md)
