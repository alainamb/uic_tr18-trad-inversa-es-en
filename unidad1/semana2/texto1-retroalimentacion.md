...
|-------------------------|------------------|
| [Formato para solicitar [7] trámite migratorio de estancia, llenado de manera electrónica a través de la página de internet, con [8] firma autógrafa del promovente]([9] https://www.inm.gob.mx/tramites/publico/estancia.html) | Original |
...
**Nota:** Para generar la [31] línea de captura del pago correspondiente ingresa a la siguiente [liga](http://www.inm.gob.mx/gobmx/word/index.php/pago-de-derechos/).
...
| 9 | https://www.inm.gob.mx/tramites/publico/estancia.html | AUD | Major | Este enlace lleva a un formato en español. Por lo menos podemos incluir una nota entre paréntesis indicando que el usuario llegará a contenido que tal vez no entienda al visitar el enlace. |
...
| 11 | Ley Federal de Derechos | ACC | Major | Hay que entender el contenido de la Ley Federal de Derechos para traducir el nombre correctamente. La ley trata de los derechos que la gente tiene que pagar para usar los servicios del gobierno. Por lo tanto, la traducción correcta es: "Federal Fees Law" o "Federal Law on Duties". |
...
| 17 | http://www.inm.gob.mx/static/vun_tramites/Escrito_para_trabajar_de_manera_independiente.pdf | AUD | Major | Este enlace lleva a un formato en español. Por lo menos podemos incluir una nota entre paréntesis indicando que el usuario llegará a contenido que tal vez no entienda al visitar el enlace. |
...
| 33 | Registrar exactamente los nombres y apellidos completos con los que se está identificando la persona extranjera en la solicitud de trámite. (Sin importar la cantidad de nombres y apellidos) | STYLE | Minor | Estas dos líneas se pueden combinar en una sola oración para una traducción más idiomática. |
