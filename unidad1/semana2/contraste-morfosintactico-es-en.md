...
**Paso 3: Identificación de Diferencias**
Identifiquen diferencias sintácticas entre el texto fuente y la traducción, basando su trabajo en las categorías del capítulo ["Syntactical, morphological and discourse issues"](referencias/Haywood_ES-EN-Grammar-Differences-Chapter.pdf) por Louise M. Haywood, Michael Thompson y Sándor Hervey.

**Paso 4: Análisis con Texto Propio**
Encuentren un texto fuente en español de 300-500 palabras que ejemplifique diferencias morfosintácticas. Pueden usar el capítulo ["Selected Structural Contrasts"](referencias/Beeby-Lonsdale_ES-EN-Structural-Contrasts.pdf) por Allison Beeby Lonsdale para ampliar su análisis.
...
**Paso 5: Presentación de Hallazgos**
Compartan sus descubrimientos con la clase, enfocándose en:
...
1. **Patrones desafiantes:** ¿Qué diferencias morfosintácticas presentan los mayores desafíos en la traducción inversa?

2. **Impacto en la fluidez:** ¿Cómo afectan estas diferencias a la naturalidad del texto traducido?

3. **Estrategias de traducción:** ¿Qué estrategias pueden desarrollarse para manejar estas diferencias de manera más efectiva?

4. **Contexto profesional:** ¿Cómo varía la importancia de estas diferencias según el tipo de texto (literario, técnico, administrativo)?
