...
3. **Creación de glosario:** Desarrolla un glosario con términos especializados (para uso personal - no es necesario que lo entregues)

#### Fase 2: Traducción técnica
1. **Aplicación terminológica:** Utiliza su glosario para mantener consistencia terminológica
