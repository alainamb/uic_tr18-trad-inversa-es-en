...
En esta asignación, realizarás una evaluación profesional de calidad de traducción del documento _Logros - Proyecto Resiliencia_ de CONANP utilizando Label Studio. Esta será tu primera evaluación completa aplicando el marco MQM que has estado estudiando durante el semestre.
...
- **Dudas técnicas con Label Studio**: Consulta la [Guía de etiquetado](https://labelstud.io/guide/labeling)
- **Dudas sobre MQM**: Revisa la [página de MQM de la semana 4](../../unidad2/semana4/marco-mqm.md)
...
**¡Unidad 3 Completa!** Repasa lo que has logrado en la [Conclusión de la Unidad 3](../unidad3-conclusion.md)
